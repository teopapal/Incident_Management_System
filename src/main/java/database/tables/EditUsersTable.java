...
public class EditUsersTable {
    ...
    public void updateUser(User user) throws ClassNotFoundException {
        try {
            ...
            pstmt.setString(9, user.getMunicipality());
            pstmt.setString(10, user.getPrefecture());
            pstmt.setString(11, user.getJob());
            pstmt.setString(12, user.getLat().toString());
            pstmt.setString(13, user.getLon().toString());
    ...
    public void myupdateUser(String id, HashMap<String, String> updates) throws SQLException, ClassNotFoundException {
        Connection con = DB_Connection.getConnection();
        Statement stmt = con.createStatement();

        for (String key : updates.keySet()) {
            String update = "UPDATE users SET " + key + "='" + updates.get(key) + "' WHERE user_id = '" + id + "'";
            stmt.executeUpdate(update);
        }
